...
test('Next.js without a static artifact still exposes a runtime preview tab without downloading ZIP', () => {
  ...
  assert.equal(needsSourceZip('preview', previewKind(project)), false);
});
