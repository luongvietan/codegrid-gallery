...
test('forces webpack for a Next 16 dependency with a dev script', () => {
  const prepared = prepareRuntimeProject(zip({
    'package.json': JSON.stringify({
...
test('forces webpack only for simple Next ranges guaranteed to install major 16 or newer', () => {
...
test('omits webpack for Next ranges that may include older majors or are ambiguous', () => {
